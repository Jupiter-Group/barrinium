...
class ThemeLoader {
    ...
    // Generate font entry from config
    generateFont() {
        ...
        return `@font-face {
            ...
            src: url("https://delivercdn.pages.dev/barrinium/fonts/vf/SeavoltUIVariable-VF.ttf");
          }
          *{
              font-family:barriniumFont;
          }`
    ...
    // Generate variables to use theme in normal .css file
    generateVars() {
        let result = `:root {
            `;
